...
An overview of each component of this template follows. We use our zero-shot classification project in [examples/zs-classifier](examples/zs-classifier) as an example.

#### The [`research/`](examples/zs-classifier/research) directory
...
#### The Python package directory (for example: [`zs_classification/`](examples/zs-classifier/zs_classification))
...
#### The [`demos/`](examples/zs-classifier/demos) directory
...
#### The [`bin/`](examples/zs-classifier/bin) directory
